           ...
           NdCopyFlag outFlag)
{
  ...
  std::function<void(size_t,char*&,char*&,Dims&,Dims&,Dims&,size_t,size_t)>copyCat;
  copyCat = [&copyCat] (size_t curDim,
                      char*& inOvlpBase,
                      char*& outOvlpBase,
                      Dims& inOvlpGapSize,
                      Dims& outOvlpGapSize,
  ...
  std::function<void(size_t,char*&,char*&,Dims&,Dims&,Dims&,size_t,
                     size_t,size_t,size_t)> endianCopyCat;
  endianCopyCat=[&endianCopyCat](size_t curDim,
                            char*& inOvlpBase,
                            char*& outOvlpBase,
                            Dims& inOvlpGapSize,
                            Dims& outOvlpGapSize,
  ...
  std::function<void(size_t,char*,char*,Dims&,Dims&,Dims&,Dims&,Dims&,size_t)>
  flippedCopyCat=[&flippedCopyCat](size_t curDim,
                             char* inBase,
                             char* outBase,
                             Dims& inRltvOvlpSPos,
  ...
  std::function<void(size_t,char*,char*,Dims&,Dims&,Dims&,Dims&,Dims&,size_t)>
  flippedEndianCopyCat=[&flippedEndianCopyCat](size_t curDim,
                                   char* inBase,
                                   char* outBase,
                                   Dims& inRltvOvlpSPos,
                                   Dims& outRltvOvlpSPos,
...
// //Full legacy code, including iterative version of the core functions
//
///*helper functions*/
